...
class UtilityWidgets
{
  ...
  late DropDownController dropDownValueController = Get.find<DropDownController>();
  ...
  bool checkCondition(
      {required bool isDependent,
        ...
        required int page ,required UiModel uiModel}) {
    /// check is dependent
    if (isDependent) {
  ...
  /// Text
  Widget buildShortText(int page, int idx, String responseTxt , UiModel uiModel) {
                ...
                child: Row(
                  children: [
                    Radio(
                        ...
                        onChanged: (value) {
                          if (value == null) {
                            radioValueController.setRadioValue(id, {
                              -1: value.toString()
                            });
                          } else {
                            radioValueController.setRadioValue(id, {
        ...
        children: [
          DropdownButton(
            ...
            onChanged: (newValue) {
              ...
              dropDownValueController.setDropdownValue(id, {
